 ...
 * <ul>
 *   <li>{@link com.alma.djynx.usecase.useCase.impl.InheritanceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InheritanceImpl extends MinimalEObjectImpl.Container implements Inheritance
{
  ...
  {
    return UseCasePackage.Literals.INHERITANCE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UseCasePackage.INHERITANCE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UseCasePackage.INHERITANCE__NAME:
        return getName();
    }
